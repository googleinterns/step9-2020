 ...
 */
class Target {
    constructor(path, collectionGroup, orderBy, filters, limit, startAt, endAt) {
        this.path = path;
        this.collectionGroup = collectionGroup;
...
class SyncEngine {
    ...
    sharedClientState, currentUser, maxConcurrentLimboResolutions) {
        ...
        this.queryViewsByQuery = new ObjectMap(q => q.canonicalId(), (l, r) => l.isEqual(r));
...
class EventManager {
    constructor(syncEngine) {
        ...
        this.queries = new ObjectMap(q => q.canonicalId(), (l, r) => l.isEqual(r));
        this.onlineState = "Unknown" /* Unknown */;
...
class FirestoreClient {
    constructor(databaseInfo, credentials, 
    /**
