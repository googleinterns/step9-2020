...
export declare class Target {
    ...
    protected constructor(path: ResourcePath, collectionGroup: string | null, orderBy: OrderBy[], filters: Filter[], limit: number | null, startAt: Bound | null, endAt: Bound | null);
}
/**
