...
var Query = /** @class */ (function () {
    ...
    Query.prototype.toString = function () {
        return "Query(target=" + stringifyTarget(this.toTarget()) + "; limitType=" + this.limitType + ")";
    };
    Query.prototype.isEqual = function (other) {
        return (targetEquals(this.toTarget(), other.toTarget()) &&
...
var TargetImpl = /** @class */ (function (_super) {
    tslib.__extends(TargetImpl, _super);
    function TargetImpl(path, collectionGroup, orderBy, filters, limit, startAt, endAt) {
        ...
        if (startAt === void 0) { startAt = null; }
        if (endAt === void 0) { endAt = null; }
        var _this = _super.call(this, path, collectionGroup, orderBy, filters, limit, startAt, endAt) || this;
        _this.memoizedCanonicalId = null;
        return _this;
    }
    return TargetImpl;
}(Target));
...
function canonifyTarget(target) {
    ...
    if (targetImpl.memoizedCanonicalId === null) {
        ...
        canonicalId_1 += '|f:';
        canonicalId_1 += targetImpl.filters.map(function (f) { return f.canonicalId(); }).join(',');
        canonicalId_1 += '|ob:';
        canonicalId_1 += targetImpl.orderBy.map(function (o) { return o.canonicalId(); }).join(',');
...
var PersistentWriteStream = /** @class */ (function (_super) {
    ...
    PersistentWriteStream.prototype.onMessage = function (responseProto) {
        ...
        this.lastStreamToken = fromBytes(this.serializer, responseProto.streamToken);
        if (!this.handshakeComplete_) {
...
var SyncEngine = /** @class */ (function () {
    ...
    sharedClientState, currentUser, maxConcurrentLimboResolutions) {
        ...
        this.queryViewsByQuery = new ObjectMap(function (q) { return q.canonicalId(); }, function (l, r) { return l.isEqual(r); });
...
var EventManager = /** @class */ (function () {
    function EventManager(syncEngine) {
        ...
        this.queries = new ObjectMap(function (q) { return q.canonicalId(); }, function (l, r) { return l.isEqual(r); });
        this.onlineState = "Unknown" /* Unknown */;
...
var FirestoreClient = /** @class */ (function () {
    function FirestoreClient(databaseInfo, credentials, 
    /**
...
var Firestore = /** @class */ (function () {
    ...
    Firestore.prototype.configureClient = function (componentProvider, persistenceSettings) {
        ...
        this._firestoreClient = new FirestoreClient(databaseInfo, this._credentials, this._queue);
...
var RESERVED_READONLY_PROPS = ['length', 'name'];
/**
...
function makeConstructorPrivate(cls, optionalMessage) {
    ...
    for (var _i = 0, _e = Object.getOwnPropertyNames(cls); _i < _e.length; _i++) {
        var staticProp = _e[_i];
        if (RESERVED_READONLY_PROPS.indexOf(staticProp) === -1) {
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            PublicConstructor[staticProp] = cls[staticProp];
        }
    }
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
